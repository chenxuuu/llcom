...
partial class Settings
{
    ...
    public int quickSendSelect
    {
        ...
        set
        {
            if (SetProperty(ref _quickSendSelect, value))
                Save();
        }
    }
    ...
    public string quickListName0
    {
        get => _quickListName0;
        set
        {
            if (SetProperty(ref _quickListName0, value))
                Save();
        }
    }

    private string _quickListName1 = "未命名1";
    public string quickListName1
    {
        get => _quickListName1;
        set
        {
            if (SetProperty(ref _quickListName1, value))
                Save();
        }
    }

    private string _quickListName2 = "未命名2";
    public string quickListName2
    {
        get => _quickListName2;
        set
        {
            if (SetProperty(ref _quickListName2, value))
                Save();
        }
    }

    private string _quickListName3 = "未命名3";
    public string quickListName3
    {
        get => _quickListName3;
        set
        {
            if (SetProperty(ref _quickListName3, value))
                Save();
        }
    }

    private string _quickListName4 = "未命名4";
    public string quickListName4
    {
        get => _quickListName4;
        set
        {
            if (SetProperty(ref _quickListName4, value))
                Save();
        }
    }

    private string _quickListName5 = "未命名5";
    public string quickListName5
    {
        get => _quickListName5;
        set
        {
            if (SetProperty(ref _quickListName5, value))
                Save();
        }
    }

    private string _quickListName6 = "未命名6";
    public string quickListName6
    {
        get => _quickListName6;
        set
        {
            if (SetProperty(ref _quickListName6, value))
                Save();
        }
    }

    private string _quickListName7 = "未命名7";
    public string quickListName7
    {
        get => _quickListName7;
        set
        {
            if (SetProperty(ref _quickListName7, value))
                Save();
        }
    }

    private string _quickListName8 = "未命名8";
    public string quickListName8
    {
        get => _quickListName8;
        set
        {
            if (SetProperty(ref _quickListName8, value))
                Save();
        }
    }

    private string _quickListName9 = "未命名9";
    public string quickListName9
    {
        get => _quickListName9;
        set
        {
            if (SetProperty(ref _quickListName9, value))
                Save();
        }
    }
