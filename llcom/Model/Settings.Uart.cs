...
namespace llcom.Model
{
    ...
    partial class Settings
    {
        ...
        {
            get => _dataToSend;
            set { if (SetProperty(ref _dataToSend, value)) Save(); }
        }
        ...
        {
            get => _autoReconnect;
            set { if (SetProperty(ref _autoReconnect, value)) Save(); }
        }
        ...
        {
            get => _autoSaveLog;
            set { if (SetProperty(ref _autoSaveLog, value)) Save(); }
        }
        ...
        {
            get => _showHexFormat;
            set { if (SetProperty(ref _showHexFormat, value)) Save(); }
        }
        ...
        {
            get => _hexSend;
            set { if (SetProperty(ref _hexSend, value)) Save(); }
        }
        ...
        {
            get => _showSend;
            set { if (SetProperty(ref _showSend, value)) Save(); }
        }
        ...
        {
            get => _showSendRaw;
            set { if (SetProperty(ref _showSendRaw, value)) Save(); }
        }
        ...
        {
            get => _timeout;
            set { if (SetProperty(ref _timeout, value)) Save(); }
        }
        ...
        {
            get => _sendScript;
            set { if (SetProperty(ref _sendScript, value)) Save(); }
        }
        ...
        {
            get => _recvScript;
            set { if (SetProperty(ref _recvScript, value)) Save(); }
        }
        ...
        {
            get => _runScript;
            set { if (SetProperty(ref _runScript, value)) Save(); }
        }
        ...
        {
            get => _terminal;
            set { if (SetProperty(ref _terminal, value)) Save(); }
        }
        ...
        {
            get => _extraEnter;
            set { if (SetProperty(ref _extraEnter, value)) Save(); }
        }
