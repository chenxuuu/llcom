...
partial class Settings
{
    ...
    public string mqttServer
    {
        ...
        set
        {
            if (SetProperty(ref _mqttServer, value))
                Save();
        }
    }
    public int mqttPort
    ...
    public string mqttClientID
    {
        ...
        set
        {
            if (SetProperty(ref _mqttClientID, value))
                Save();
        }
    }
    public bool mqttTLS
    {
        ...
        set
        {
            if (SetProperty(ref _mqttTLS, value))
                Save();
        }
    }
    public bool mqttTLSCert
    {
        get => _mqttTLSCert;
        set
        {
            if (SetProperty(ref _mqttTLSCert, value))
                Save();
        }
    }
    public string mqttTLSCertCaPath
    {
        get => _mqttTLSCertCaPath;
        set
        {
            if (SetProperty(ref _mqttTLSCertCaPath, value))
                Save();
        }
    }
    public string mqttTLSCertClientPath
    {
        get => _mqttTLSCertClientPath;
        set
        {
            if (SetProperty(ref _mqttTLSCertClientPath, value))
                Save();
        }
    }
    public string mqttTLSCertClientPassword
    {
        get => _mqttTLSCertClientPassword;
        set
        {
            if (SetProperty(ref _mqttTLSCertClientPassword, value))
                Save();
        }
    }
    public bool mqttWs
    {
        ...
        set
        {
            if (SetProperty(ref _mqttWs, value))
                Save();
        }
    }
    public string mqttWsPath
    {
        get => _mqttWsPath;
        set
        {
            if (SetProperty(ref _mqttWsPath, value))
                Save();
        }
    }
    public string mqttUser
    {
        ...
        set
        {
            if (SetProperty(ref _mqttUser, value))
                Save();
        }
    }
    ...
    public int mqttKeepAlive
    {
        ...
        set
        {
            if (SetProperty(ref _mqttKeepAlive, value))
                Save();
        }
    }
    public bool mqttCleanSession
    {
        ...
        set
        {
            if (SetProperty(ref _mqttCleanSession, value))
                Save();
        }
    }
    public string mqttPublishTopic
    {
        get => _mqttPublishTopic;
        set
        {
            if (SetProperty(ref _mqttPublishTopic, value))
                Save();
        }
    }
    public string mqttSubscribeTopic
    {
        get => _mqttSubscribeTopic;
        set
        {
            if (SetProperty(ref _mqttSubscribeTopic, value))
                Save();
        }
    }
}
